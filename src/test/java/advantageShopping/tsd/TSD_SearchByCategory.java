...
public class TSD_SearchByCategory {
	...
	public Object[][] excelDP() throws IOException {
		...
		if (Objects.equals(null, dataProviderObject)) {
			return new Object[][] { new Object[] { "laptops" },
					{ "tablets" },
					{ "speakers" },};
		}
	...
	@Test(dataProvider = "excel-data", description = "Search item by category name")
	public void searchItemByCategory(String categoryName) {
		try {
			Page_Navbar navbar = new Page_Navbar(driver);
			driver.get(Page_Navbar.URL);
			Boolean valueExpected = true;
			Boolean resp = navbar.goToSearchAndSearchByCategory(categoryName);
