...
/**
 * Copyright: Softtek. Description: this page contains functions of the shopping
 * cart.
 * 
...
public class Page_ShoppingCart extends PageTemplate {
	...
	public boolean deleteItems(String product) {
		String xpathDeleteItem = "//label[contains(text(),'" + product
				+ "')]/../..//span/a[contains(@data-ng-click,'removeProduct')]";
	 ...
	 * 
	 * @product = Name of the product we want to edit (ie:
	...
	public boolean checkOut() {
		try {
			...
			// This line fixes the issue when the shopping cart is long (it has more 6
			// different items) for now it's commented
